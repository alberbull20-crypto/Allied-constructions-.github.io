...
function seedDataIfEmpty(){
  ...
  if(!localStorage.getItem(STORAGE_KEYS.work)){
    writeStore(STORAGE_KEYS.work, [
      ...
      { id: uid(), title: 'Dining space — statement lighting', category: 'interiors', description: 'Porcelain tile flooring, sliding aluminium windows and a custom iron pendant fixture.', image: 'images/work-dining.jpg' },
...
function renderGallery(){
  ...
  qs('#galleryGrid').innerHTML = filtered.map(item => `
...
function initAuthForms(){
  ...
  ['heroContactBtn', 'ctaContactBtn'].forEach(id => {
